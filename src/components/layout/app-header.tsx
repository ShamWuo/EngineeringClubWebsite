...
export function AppHeader({ currentUser, notifications, clubName }: AppHeaderProps) {
  return (
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-zinc-850 bg-black/90 backdrop-blur-md px-4 sm:px-6">
      <div className="flex items-center gap-3">
        <Link href="/dashboard" className="flex items-center gap-2.5 group">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-red-600 text-white shadow-md shadow-red-950/60 border border-red-500 group-hover:scale-105 transition-transform">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-3xs text-zinc-500 font-mono uppercase tracking-wider">Members Portal</span>
          </div>
        </Link>
      </div>
