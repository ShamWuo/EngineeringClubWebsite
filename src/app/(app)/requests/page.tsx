...
import { Plus, Send, Trophy, Users, Lightbulb, DollarSign, HelpCircle, MessageSquare } from 'lucide-react';
    ...
    switch (kind) {
      case 'competition':
        return {
          label: 'Competition',
          icon: Trophy,
          bg: 'bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-950/60 dark:text-amber-400 dark:border-amber-800',
        };
      case 'team':
        return {
          label: 'Subteam',
      ...
      case 'workshop':
        return {
          label: 'Workshop',
          icon: Lightbulb,
          bg: 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-950/60 dark:text-emerald-400 dark:border-emerald-800',
        };
      case 'funding':
        return {
          label: 'Funding',
          icon: DollarSign,
          bg: 'bg-purple-50 text-purple-700 border-purple-200 dark:bg-purple-950/60 dark:text-purple-400 dark:border-purple-800',
        };
      default:
        return {
          label: 'Equipment / Other',
          icon: HelpCircle,
          bg: 'bg-zinc-100 text-zinc-700 border-zinc-300 dark:bg-zinc-800 dark:text-zinc-300 dark:border-zinc-700',
        };
    }
  };
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        <Link href="/requests/new?type=competition" className="group">
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-900/50 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:border-red-500/50 transition-all text-center space-y-2 cursor-pointer h-full flex flex-col items-center justify-center shadow-2xs">
            ...
            <div>
              <div className="font-bold text-xs text-zinc-800 dark:text-zinc-200 group-hover:text-amber-600 dark:group-hover:text-amber-400">Competition</div>
              <div className="text-3xs text-zinc-500 dark:text-zinc-400">Enter a challenge</div>
            </div>
          </div>
        </Link>
        ...
        <Link href="/requests/new?type=funding" className="group">
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-900/50 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:border-red-500/50 transition-all text-center space-y-2 cursor-pointer h-full flex flex-col items-center justify-center shadow-2xs">
            ...
            <div>
              <div className="font-bold text-xs text-zinc-800 dark:text-zinc-200 group-hover:text-purple-600 dark:group-hover:text-purple-400">Funding / Parts</div>
              <div className="text-3xs text-zinc-500 dark:text-zinc-400">Hardware & quotes</div>
            </div>
          </div>
        </Link>
        ...
        <Link href="/requests/new?type=workshop" className="group">
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-900/50 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:border-red-500/50 transition-all text-center space-y-2 cursor-pointer h-full flex flex-col items-center justify-center shadow-2xs">
            ...
            <div>
              <div className="font-bold text-xs text-zinc-800 dark:text-zinc-200 group-hover:text-emerald-600 dark:group-hover:text-emerald-400">Workshop</div>
              <div className="text-3xs text-zinc-500 dark:text-zinc-400">Learn or teach</div>
            </div>
          </div>
        </Link>
        ...
        <Link href="/requests/new?type=general" className="group col-span-2 md:col-span-1">
          <div className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-900/50 hover:bg-zinc-50 dark:hover:bg-zinc-900 hover:border-red-500/50 transition-all text-center space-y-2 cursor-pointer h-full flex flex-col items-center justify-center shadow-2xs">
            ...
            <div>
              <div className="font-bold text-xs text-zinc-800 dark:text-zinc-200 group-hover:text-zinc-900 dark:group-hover:text-zinc-100">Equipment / Other</div>
              <div className="text-3xs text-zinc-500 dark:text-zinc-400">Tools, ideas, access</div>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-3">
          <h2 className="text-base font-bold text-zinc-900 dark:text-white flex items-center gap-2">
            ...
            <span className="text-xs bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-400 px-2 py-0.5 rounded-full font-mono">
              {allRequests.length}
            </span>
          </h2>
        </div>
          ...
          <div className="space-y-3">
            {allRequests.map((req) => {
              ...
              return (
                <div
                  key={`${req.kind}-${req.id}`}
                  className="p-4 rounded-xl border border-zinc-200 dark:border-zinc-800/80 bg-white dark:bg-zinc-900/60 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all space-y-3 shadow-2xs hover:shadow-sm"
                >
